...
public class OTPValidationRequest  {
    ...
    * IVR OTP
    **/
    public OTPValidationRequest ivrOTP(String ivrOTP) {

        this.ivrOTP = ivrOTP;
        return this;
    }
    
    @ApiModelProperty(value = "IVR OTP")
    @JsonProperty("ivrOTP")
    @Valid
    public String getIvrOTP() {
        return ivrOTP;
    }
    public void setIvrOTP(String ivrOTP) {
        this.ivrOTP = ivrOTP;
    }
    ...
    public boolean equals(java.lang.Object o) {
        ...
        return Objects.equals(this.userId, otPValidationRequest.userId) &&
            ...
            Objects.equals(this.ivrOTP, otPValidationRequest.ivrOTP);
    }

    @Override
    public int hashCode() {
        return Objects.hash(userId, transactionId, ivrOTP);
    }
    ...
    public String toString() {
        ...
        sb.append("    ivrOTP: ").append(toIndentedString(ivrOTP)).append("\n");
        sb.append("}");
        return sb.toString();
    }
